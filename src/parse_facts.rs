...
pub const _MSFT_FACTS: &str = "resources/test-data/CIK0000789019.json";
pub const _FB_FACTS: &str = "resources/test-data/CIK0001326801.json";
pub const _AMZN_FACTS: &str = "resources/test-data/CIK0001018724.json";
pub const _AAPL_FACTS: &str = "resources/test-data/CIK0000320193.json";
pub const _NFLX_FACTS: &str = "resources/test-data/CIK0001065280.json";
pub const _GOOG_FACTS: &str = "resources/test-data/CIK0001652044.json";

/*
TODO: Can we enable strict parsing, so we know when an element is not successfully mapped to a data
 structure?
 */
pub fn _open_file(file: &str) -> Filer {
